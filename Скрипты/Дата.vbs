Private Sub Worksheet_Change(ByVal Target As Range)
    ...
    'MsgBox "Worksheet_Change вызван для ячейки/диапазона: " & Target.Address
    ...
    If tbl Is Nothing Then
        'MsgBox "Ошибка: Таблица 'Таблица1' не найдена!"
        Exit Sub
    Else
        'MsgBox "Таблица 'Таблица1' найдена."
    End If
    ...
    If dCol Is Nothing Then
        'MsgBox "Ошибка: Столбец 'Дата' не найден!"
        Exit Sub
    Else
        'MsgBox "Столбец 'Дата' найден."
    End If
    ...
    If Not Intersect(Target, tbl.DataBodyRange) Is Nothing Then
        ...
        'MsgBox "Изменение произошло в пределах данных таблицы."
        ...
        For Each cell In Target
            ...
            'MsgBox "Обрабатываем строку " & rowNumber & _
            ...
            If Trim(dateCell.Value) = "" Then
                dateCell.Value = Date
                'MsgBox "В ячейку " & dateCell.Address & " установлена дата: " & Date
            Else
                'MsgBox "Ячейка " & dateCell.Address & " уже содержит значение: " & dateCell.Value
            End If
        Next cell

        Application.EnableEvents = True
    Else
        'MsgBox "Изменение не произошло в диапазоне данных таблицы."
    End If
End Sub
